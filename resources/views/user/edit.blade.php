        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <form action="{{ route('user.update', $user->id) }}" method="post">
                    ...
                    </div>@error('patronymic'){{ $message }} @enderror
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <select name="gender" class="custom-select form-control" id="exampleSelectBorder">
                            ...
                            <option {{ $user->gender == 1 ?? old('gender') == 1 ? ' selected' : '' }} value="1">Female</option>
                            <option {{ $user->gender == 2 ?? old('gender') == 2 ? ' selected' : '' }} value="2">Male</option>
                        </select>
                    </div>
                    <div class="form-group">
